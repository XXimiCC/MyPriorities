    ...
    >
      ...
      <div className="bk__block">
        ...
        <p className="bk__text">
          ...
          Собственного <code className="bk__code">:active</code> у кнопок нет ни у одной, и это
          правило: пока каждая нажималась по-своему, одинаковые по форме кнопки отзывались
          по-разному, и разница читалась как неисправность. Новая кнопка без{' '}
          <code className="bk__code">.press</code> выглядит сломанной, даже когда работает.
        </p>
