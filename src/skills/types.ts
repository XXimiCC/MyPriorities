...
/**
 * Двенадцать здесь стояло не по вкусу, а по лимиту: месяц с двенадцатью
 * навыками занимал около 3200 символов при пределе CloudStorage в 4096.
 *
 * Лимита больше нет — история живёт в журнале операций, и хранилищу всё равно,
 * сколько навыков. Оставшиеся числа держат уже не схему, а экран: список из
 * сотни навыков нечитаем, а «сколько всего» перестаёт что-либо значить. Менять
 * их теперь можно свободно, ничего не пересчитывая.
 */
export const MAX_SKILLS = 24;
export const MAX_ARCHIVED_SKILLS = 48;
