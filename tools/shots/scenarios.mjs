...
const maxed = [
  {
    /*
     * Постер под живым фреймом лендинга. Фрейм грузится этим же `?mock=max`,
     * и профиль обязан совпадать: пока постером стоял кадр «Артёма», подмена
     * постера на фрейм читалась как «приложение подменили на другое».
     */
    name: 'home-max',
    note: 'Профиль «Максимум» без плашки: то же, что видно в рамке на лендинге',
    setup: () => Promise.resolve(),
  },
  {
